...
#ifndef INCLUDED_BLAZEFILE_H_23893489
#define INCLUDED_BLAZEFILE_H_23893489
...
namespace Pylon
{
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnImagesSkipped( CBlazeInstantCamera& camera, size_t countOfSkippedImages)
        {
            PYLON_UNUSED(&camera);
        ...
        \threading
            This method is called outside the lock of the camera object but inside the lock of the image event handler registry.
        */
        virtual void OnImageGrabbed( CBlazeInstantCamera& camera, const BlazeGrabResultPtr& grabResult)
        {
            PYLON_UNUSED(&camera);
        ...
        */
        virtual void OnImageEventHandlerRegistered( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the image event handler registry.
        */
        virtual void OnImageEventHandlerDeregistered( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        */
        ...
        /// Create.
        CBlazeImageEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        CBlazeImageEventHandler(const CBlazeImageEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        CBlazeImageEventHandler& operator=(const CBlazeImageEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~CBlazeImageEventHandler()
        {
...
#endif /* INCLUDED_BLAZEFILE_H_23893489 */