...
#ifndef INCLUDED_BLAZEFILE_H_03474787
#define INCLUDED_BLAZEFILE_H_03474787
...
namespace Pylon
{
    ...
    /**
    \class  CBlazeCameraEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnCameraEvent( CBlazeInstantCamera& camera, intptr_t userProvidedId, GENAPI_NAMESPACE::INode* pNode)
        {
            PYLON_UNUSED(&camera);
        ...
        \param[in]  userProvidedId  This ID is passed as a parameter in CBlazeCameraEventHandler::OnCameraEvent and can be used to distinguish between different events.
        ...
        */
        virtual void OnCameraEventHandlerRegistered( CBlazeInstantCamera& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
            PYLON_UNUSED(&camera);
        ...
        \threading
            This method is called inside the lock of the camera event handler registry.
        */
        virtual void OnCameraEventHandlerDeregistered( CBlazeInstantCamera& camera, const String_t& nodeName, intptr_t userProvidedId)
        {
            PYLON_UNUSED(&camera);
            PYLON_UNUSED(nodeName);
            PYLON_UNUSED(userProvidedId);
        ...
        */
        ...
        /// Create.
        CBlazeCameraEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        CBlazeCameraEventHandler(const CBlazeCameraEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        CBlazeCameraEventHandler& operator=(const CBlazeCameraEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~CBlazeCameraEventHandler()
        {
...
#endif /* INCLUDED_BLAZEFILE_H_03474787 */