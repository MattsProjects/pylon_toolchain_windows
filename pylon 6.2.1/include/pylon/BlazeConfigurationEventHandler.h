...
#ifndef INCLUDED_BLAZEFILE_H_27473547
#define INCLUDED_BLAZEFILE_H_27473547
...
namespace Pylon
{
    ...
    /**
    \class  CBlazeConfigurationEventHandler
    ...
    */
    ...
    public:
        ...
        */
        virtual void OnAttach( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnAttached( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDetach( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDetached( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDestroy( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnDestroyed( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnOpen( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnOpened( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnClose( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnClosed( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStart( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStarted( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStop( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabStopped( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnGrabError( CBlazeInstantCamera& camera, const char* errorMessage)
        {
            PYLON_UNUSED(&camera);
        ...
        */
        virtual void OnCameraDeviceRemoved( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnConfigurationRegistered( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        \threading
            This method is called inside the lock of the camera object.
        */
        virtual void OnConfigurationDeregistered( CBlazeInstantCamera& camera)
        {
            PYLON_UNUSED(&camera);
        }
        ...
        */
        ...
        /// Create.
        CBlazeConfigurationEventHandler()
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Copy.
        CBlazeConfigurationEventHandler(const CBlazeConfigurationEventHandler&)
            : m_eventHandlerRegistrationCount(0)
        {
        }

        /// Assign.
        CBlazeConfigurationEventHandler& operator=(const CBlazeConfigurationEventHandler&)
        {
            return *this;
        }

        /// Destruct.
        virtual ~CBlazeConfigurationEventHandler()
        {
...
#endif /* INCLUDED_BLAZEFILE_H_27473547 */