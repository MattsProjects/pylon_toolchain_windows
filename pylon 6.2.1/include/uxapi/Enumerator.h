...
namespace uxapi
{
    ...
    enum EDeviceType
    {
        ...
        DeviceType_ThirdPartyBaslerUsb //!< A third party product using Basler Third Party USB driver.
    };
    ...
    inline bool IsValid( DeviceDiscoveryInfo info )
    {
        bool b = true;
        b = (info.BcdUsb != 0) && b;
        b = (info.SpeedSupport != 0) && b;
        b = (info.VendorID != 0) && b;
        b = (info.ProductID != 0) && b;
        // skip the other fields for performance reasons
