...
#define UX_STATUS_FACILITY_UXDRV         0x201
...
// MessageText:
//
// Failed to read the first register (maximum device response time). This can be caused by problems with the USB hardware used, i.e., the USB host controller and its corresponding driver or the USB cable. Make sure to follow Basler's recommendations regarding USB host controllers, driver versions, cables, and cable lengths.%0
//
...
//
// MessageId: UX_E_LIBUSB_ERROR_IO
//
// MessageText:
//
// The input/output action with the device failed. %0
//
#define UX_E_LIBUSB_ERROR_IO             ((UXSTATUS)0xA2101001L)

//
// MessageId: UX_E_LIBUSB_ERROR_INVALID_PARAM
//
// MessageText:
//
// An invalid parameter has been passed.%0
//
#define UX_E_LIBUSB_ERROR_INVALID_PARAM  ((UXSTATUS)0xE2101002L)

//
// MessageId: UX_E_LIBUSB_ERROR_ACCESS
//
// MessageText:
//
// The current user has insufficient permissions for device communications.%0
//
#define UX_E_LIBUSB_ERROR_ACCESS         ((UXSTATUS)0xE2101003L)

//
// MessageId: UX_E_LIBUSB_ERROR_NOT_FOUND
//
// MessageText:
//
// The requested data was not found.%0
//
#define UX_E_LIBUSB_ERROR_NOT_FOUND      ((UXSTATUS)0xE2101005L)

//
// MessageId: UX_E_LIBUSB_ERROR_BUSY
//
// MessageText:
//
// Another program or driver has claimed the usb interface.%0
//
#define UX_E_LIBUSB_ERROR_BUSY           ((UXSTATUS)0xE2101006L)

//
// MessageId: UX_E_LIBUSB_ERROR_OVERFLOW
//
// MessageText:
//
// The port numbers array is too small.%0
//
#define UX_E_LIBUSB_ERROR_OVERFLOW       ((UXSTATUS)0xE2101008L)

//
// MessageId: UX_E_LIBUSB_ERROR_PIPE
//
// MessageText:
//
// Pipe error.%0
//
#define UX_E_LIBUSB_ERROR_PIPE           ((UXSTATUS)0xE2101009L)

//
// MessageId: UX_E_LIBUSB_ERROR_INTERRUPTED
//
// MessageText:
//
// System call interrupted, perhaps due to signal.%0
//
#define UX_E_LIBUSB_ERROR_INTERRUPTED    ((UXSTATUS)0xE210100AL)

//
// MessageId: UX_E_LIBUSB_ERROR_NO_MEM
//
// MessageText:
//
// Not enough memory to submit transfer. You can increase the usbfs memory by modifying /sys/module/usbcore/parameters/usbfs_memory_mb.%0
//
#define UX_E_LIBUSB_ERROR_NO_MEM         ((UXSTATUS)0xE210100BL)

//
// MessageId: UX_E_LIBUSB_ERROR_NOT_SUPPORTED
//
// MessageText:
//
// The operation is not supported on this platform.%0
//
#define UX_E_LIBUSB_ERROR_NOT_SUPPORTED  ((UXSTATUS)0xE210100CL)
