    ...
    public:
        ...
        */
        ...
        enum EPropertyValue
        {
            ...
            */                                                                  //$
            TransferLoopThreadPriorityValue = 0xA00,                            //$
            /** \brief Maximum value of TransferLoopThreadPriority */           //$
            TransferLoopThreadPriorityMax = 0xA08,                              //$
            /** \brief Minimum value of TransferLoopThreadPriority */           //$
            TransferLoopThreadPriorityMin = 0xA10,                              //$
                                                                                //$
            /**                                                                 //$
                \brief Value of TransferTimeout. The type is int32_t.           //$
                Timeout for payload and trailer transfers.                      //$
            */                                                                  //$
            TransferTimeoutValue = 0xB00,                                       //$
            /** \brief Maximum value of TransferTimeout */                      //$
            TransferTimeoutMax = 0xB08,                                         //$
            /** \brief Minimum value of TransferTimeout */                      //$
            TransferTimeoutMin = 0xB10,                                         //$
                                                                                //$
