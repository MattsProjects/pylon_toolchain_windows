...
/*!
\file
\brief A parameter class containing all parameters as members that are available for Usb, GigE, 1394, and BCON
*/
...
#ifndef BASLER_PYLON_Basler_UniversalStreamParams_PARAMS_H
#define BASLER_PYLON_Basler_UniversalStreamParams_PARAMS_H
...
namespace Basler_UniversalStreamParams
{
    ...
    //! A parameter class containing all parameters as members that are available for Usb, GigE, 1394, and BCON
    ...
    //! \name Categories Debug and StreamGrabber
    //@{
    /*!
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum size (in bytes) of a buffer used for grabbing images - Applies to: Usb, GigE, 1394 and BCON
    ...
    */
    ...
    //@{
    /*!
        \brief Maximum number of buffers that can be used simultaneously for grabbing images - Applies to: Usb, GigE, 1394 and BCON
    ...
    */
    ...
    //@{
    /*!
        \brief Size of the payload in bytes - Applies to: BCON
    ...
    */
    ...
    //@{
    /*!
        \brief Indicates the current status of the stream grabber - Applies to: GigE and 1394
    ...
    */
    ...
    //! \name Category OutputThread
    //@{
    /*!
        \brief The thread priority - Applies to: 1394
    ...
    */
    Pylon::IIntegerEx& ThreadPriority;
    ...
    //@{
    /*!
        \brief If enabled the user can set a custom thread priority - Applies to: 1394

    
        \b Visibility = Guru

    */
    Pylon::IBooleanEx& ThreadPriorityOverride;
    ...
    //@{
    /*!
        \brief Timeout value in milliseconds for the output thread - Applies to: 1394

    
        \b Visibility = Expert

    */
    Pylon::IIntegerEx& ThreadTimeout;
...
#endif // BASLER_PYLON_Basler_UniversalStreamParams_PARAMS_H
