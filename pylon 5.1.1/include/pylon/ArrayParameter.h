...
/*!
\file
\brief Contains the class CArrayParameter used for simplifying access to %GenApi parameters.
*/
...
namespace Pylon
{
    ...
    */
    ...
    /*!
    \brief CArrayParameter class used for simplifying access to %GenApi parameters.
    */
    class PYLONBASE_API CArrayParameter : virtual public IRegisterEx, public CParameter
    {
    public:
        /*!
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        CArrayParameter(GENAPI_NAMESPACE::INode* pNode);
        ...
        \post
            The parameter object must not be used to access the node's functionality if the source of the attached \c pRegister has been destroyed until Release() has been called or a new node has been attached.
        \error
            Does not throw C++ exceptions.
        */
        CArrayParameter(GENAPI_NAMESPACE::IRegister* pRegister);
        ...
        */
        CArrayParameter(GENAPI_NAMESPACE::INodeMap* pNodeMap, const char* name);
        ...
        \error
            The call to GenApi::INodeMap::GetNode can throw C++ exceptions.
        */
        CArrayParameter(GENAPI_NAMESPACE::INodeMap& nodeMap, const char* name);

        
        /*!
        \brief Copys a CArrayParameter object.
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const CArrayParameter& rhs) const;
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const GENAPI_NAMESPACE::IRegister* pRegister) const;
