...
/*!
\file
\brief Contains the class CFloatParameter used for simplifying access to %GenApi parameters.
*/
    ...
    */
    interface IFloatEx : virtual public GENAPI_NAMESPACE::IFloat, virtual public IValueEx
    {
        ...
        */
        ...
        /*!
        \brief Sets the provided value to a value within the range, using this formula (simplified): ((max - min) * (percentOfRange / 100.0)) + min.
        ...
        */
        ...
        /*!
        \brief If the parameter is writable and readable, sets the value passed to a value within the range, using this formula (simplified): ((max - min) * (percentOfRange / 100.0)) + min
        ...
        */
        ...
        The alternative integer representation is typically used if a parameter is represented as a float value with unit in the node map,
        but in the camera device the parameter is represented as integer register.
    ...
    /*!
    \brief CFloatParameter class used for simplifying access to %GenApi parameters.
    */
    class PYLONBASE_API CFloatParameter : virtual public IFloatEx, public CParameter
    {
    public:
        /*!
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        CFloatParameter(GENAPI_NAMESPACE::INode* pNode);
        ...
        \post
            The parameter object must not be used to access the node's functionality if the source of the attached \c pFloat has been destroyed until Release() has been called or a new node has been attached.
        \error
            Does not throw C++ exceptions.
        */
        CFloatParameter(GENAPI_NAMESPACE::IFloat* pFloat);
        ...
        */
        CFloatParameter(GENAPI_NAMESPACE::INodeMap* pNodeMap, const char* name);
        ...
        \error
            The call to GenApi::INodeMap::GetNode can throw C++ exceptions.
        */
        CFloatParameter(GENAPI_NAMESPACE::INodeMap& nodeMap, const char* name);

        
        /*!
        \brief Copys a CFloatParameter object.
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const CFloatParameter& rhs) const;
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const GENAPI_NAMESPACE::IFloat* pFloat) const;
