...
/*!
\file
\brief Contains the class CBooleanParameter used for simplifying access to %GenApi parameters.
*/
...
namespace Pylon
{
    ...
    */
    interface IBooleanEx : virtual public GENAPI_NAMESPACE::IBoolean, virtual public IValueEx
    {
        ...
        /*!
        \brief Sets the provided bool value if the parameter is writable.
    ...
    /*!
    \brief CBooleanParameter class used for simplifying access to %GenApi parameters.
    */
    class PYLONBASE_API CBooleanParameter : virtual public IBooleanEx, public CParameter
    {
    public:
        /*!
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        CBooleanParameter(GENAPI_NAMESPACE::INode* pNode);
        ...
        \post
            The parameter object must not be used to access the node's functionality if the source of the attached \c pBoolean has been destroyed until Release() has been called or a new node has been attached.
        \error
            Does not throw C++ exceptions.
        */
        CBooleanParameter(GENAPI_NAMESPACE::IBoolean* pBoolean);
        ...
        */
        CBooleanParameter(GENAPI_NAMESPACE::INodeMap* pNodeMap, const char* name);
        ...
        \error
            The call to GenApi::INodeMap::GetNode can throw C++ exceptions.
        */
        CBooleanParameter(GENAPI_NAMESPACE::INodeMap& nodeMap, const char* name);

        
        /*!
        \brief Copys a CBooleanParameter object.
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const CBooleanParameter& rhs) const;
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const GENAPI_NAMESPACE::IBoolean* pBoolean) const;
