...
/*!
\file
\brief Contains the class CStringParameter used for simplifying access to %GenApi parameters.
*/
...
namespace Pylon
{
    ...
    */
    interface IStringEx : virtual public GENAPI_NAMESPACE::IString, virtual public IValueEx
    {
        ...
        /*!
        \brief Sets the provided value if the parameter is writable.
    ...
    /*!
    \brief CStringParameter class used for simplifying access to %GenApi parameters.
    */
    class PYLONBASE_API CStringParameter : virtual public IStringEx, public CParameter
    {
    public:
        /*!
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        CStringParameter(GENAPI_NAMESPACE::INode* pNode);
        ...
        \post
            The parameter object must not be used to access the node's functionality if the source of the attached \c pString has been destroyed until Release() has been called or a new node has been attached.
        \error
            Does not throw C++ exceptions.
        */
        CStringParameter(GENAPI_NAMESPACE::IString* pString);
        ...
        */
        CStringParameter(GENAPI_NAMESPACE::INodeMap* pNodeMap, const char* name);
        ...
        \error
            The call to GenApi::INodeMap::GetNode can throw C++ exceptions.
        */
        CStringParameter(GENAPI_NAMESPACE::INodeMap& nodeMap, const char* name);

        
        /*!
        \brief Copys a CStringParameter object.
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const CStringParameter& rhs) const;
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const GENAPI_NAMESPACE::IString* pString) const;
