...
/*!
\file
\brief Contains the class CCommandParameter used for simplifying access to %GenApi parameters.
*/
...
namespace Pylon
{
    ...
    */
    ...
    /*!
    \brief CCommandParameter class used for simplifying access to %GenApi parameters.
    */
    class PYLONBASE_API CCommandParameter : virtual public ICommandEx, public CParameter
    {
    public:
        /*!
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        CCommandParameter(GENAPI_NAMESPACE::INode* pNode);
        ...
        \post
            The parameter object must not be used to access the node's functionality if the source of the attached \c pCommand has been destroyed until Release() has been called or a new node has been attached.
        \error
            Does not throw C++ exceptions.
        */
        CCommandParameter(GENAPI_NAMESPACE::ICommand* pCommand);
        ...
        */
        CCommandParameter(GENAPI_NAMESPACE::INodeMap* pNodeMap, const char* name);
        ...
        \error
            The call to GenApi::INodeMap::GetNode can throw C++ exceptions.
        */
        CCommandParameter(GENAPI_NAMESPACE::INodeMap& nodeMap, const char* name);

        
        /*!
        \brief Copys a CCommandParameter object.
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const CCommandParameter& rhs) const;
        ...
        */
        ...
        \error
            Does not throw C++ exceptions.
        */
        virtual bool operator==(const GENAPI_NAMESPACE::ICommand* pCommand) const;
