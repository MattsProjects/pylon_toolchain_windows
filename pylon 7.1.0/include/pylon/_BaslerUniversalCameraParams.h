...
namespace Basler_UniversalCameraParams
{
    ...
    {
        BinningHorizontalMode_Average,  //!< The values of the binned pixels are averaged - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        BinningHorizontalMode_Sum  //!< The values of the binned pixels are summed - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    {
        BinningVerticalMode_Average,  //!< The values of the binned pixels are averaged - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        BinningVerticalMode_Sum  //!< The values of the binned pixels are summed - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    {
        ExposureAuto_Continuous,  //!< The exposure time is adjusted continuously while images are being acquired - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ExposureAuto_Off,  //!< Automatic exposure time adjustment is disabled - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ExposureAuto_Once  //!< The exposure time is adjusted automatically to reach the specified target value - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    enum ExposureModeEnums
    {
        ...
        ExposureMode_TriggerWidth  //!< The exposure mode is set to Trigger Width - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
    };
    ...
    enum GainAutoEnums
    {
        GainAuto_Continuous,  //!< The gain is adjusted continuously while images are being acquired - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        GainAuto_Off,  //!< Automatic gain adjustment is disabled - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        GainAuto_Once  //!< The gain is adjusted automatically to reach the specifed target value - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
    };
    ...
    enum LineModeEnums
    {
        LineMode_InOut,  //!< The selected physical line can be used to input and output an electrical signal - Applies to: ace 2 GigE, ace 2 USB, boost CoaXPress and dart 2 USB
        LineMode_Input,  //!< The selected physical line can be used to input an electrical signal - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineMode_Output  //!< The selected physical line can be used to output an electrical signal - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
    };
    ...
    enum LineSelectorEnums
    {
        ...
        LineSelector_Line1,  //!< Line 1 can be configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSelector_Line2,  //!< Line 2 can be configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSelector_Line3,  //!< Line 3 can be configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
    ...
    enum LineSourceEnums
    {
        ...
        LineSource_ExposureActive,  //!< The source signal for the currently selected line is set to Exposure Active - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        LineSource_UserOutput1,  //!< The source signal for the currently selected line is set to User Output 1 - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSource_UserOutput2,  //!< The source signal for the currently selected line is set to User Output 2 - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        LineSource_UserOutput3,  //!< The source signal for the currently selected line is set to User Output 3 - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
    ...
    {
        TriggerActivation_AnyEdge,  //!< The selected trigger is activated by the falling or rising edge of the source signal - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        TriggerActivation_FallingEdge,  //!< The selected trigger is activated by the falling edge of the source signal - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI and dart USB
        TriggerActivation_LevelHigh,  //!< The selected trigger is activated when the source signal is high - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        TriggerActivation_LevelLow,  //!< The selected trigger is activated when the source signal is low - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        TriggerActivation_RisingEdge  //!< The selected trigger is activated by the rising edge of the source signal - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    };
    ...
    enum TriggerSelectorEnums
    {
        ...
        TriggerSelector_FrameStart,  //!< The Frame Start trigger can be configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
    ...
    enum TriggerSourceEnums
    {
        ...
        TriggerSource_Line1,  //!< The source signal for the selected trigger is set to Line 1 - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        TriggerSource_Line3,  //!< The source signal for the selected trigger is set to Line 3 - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress and dart 2 USB
        ...
        TriggerSource_PeriodicSignal1,  //!< The source signal for the selected trigger is set to Periodic Signal 1 - Applies to: ace 2 GigE and dart MIPI
    ...
    enum UserOutputSelectorEnums
    {
        ...
        UserOutputSelector_UserOutput1,  //!< The user-settable output signal 1 can be configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        UserOutputSelector_UserOutput2,  //!< The user-settable output signal 2 can be configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
    ...
    */
    ...
    public:
        ...
        */
        ...
        //@{
        /*!
            \brief Acquisition frame rate of the camera in frames per second - Applies to: ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent horizontal pixels to be summed - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for horizontal binning - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Number of adjacent vertical pixels to be summed - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the binning mode for vertical binning - Applies to: GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Black level value to be applied to the currently selected sensor tap - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Exposure Auto auto function - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Exposure time of the camera in microseconds - Applies to: ace 2 GigE, ace 2 USB, ace USB, blaze, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Value of the currently selected gain in dB - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the operation mode of the Gain Auto auto function - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Gamma correction to be applied - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the signal inverter function for the currently selected input or output line - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the mode for the selected line - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the I/O line to be configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the source signal for the currently selected line - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables horizontal mirroring of the image - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables vertical mirroring of the image - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart USB and pulse USB
  ...
  errors causing planar surfaces to appear curved.
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the type of signal transition that will activate the selected trigger - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB, dart MIPI, dart USB and pulse USB
        ...
        */
        ...
        //@{
        /*!
            \brief Trigger delay time in microseconds - Applies to: ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart MIPI
        ...
        */
        ...
        //@{
        /*!
            \brief Sets the user-settable output signal to be configured - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
        ...
        */
        ...
        //@{
        /*!
            \brief Enables the selected user-settable output line - Applies to: CameraLink, GigE, ace 2 GigE, ace 2 USB, ace USB, boost CoaXPress, dart 2 USB and dart USB
