...
/*!
\file
\brief A parameter class containing all parameters as members that are available for Usb, GigE, and 1394
*/
...
#ifndef BASLER_PYLON_Basler_UniversalEventParams_PARAMS_H
#define BASLER_PYLON_Basler_UniversalEventParams_PARAMS_H
...
namespace Basler_UniversalEventParams
{
    ...
    //! A parameter class containing all parameters as members that are available for Usb, GigE, and 1394
    ...
    //@{
    /*!
        \brief Number of buffers to be used - Applies to: Usb, GigE and 1394
...
#endif // BASLER_PYLON_Basler_UniversalEventParams_PARAMS_H
