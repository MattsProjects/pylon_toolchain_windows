...
namespace Basler_BconCameraParams
{
    ...
    */
    ...
    //@{
    /*!
        \brief Pixel size in bits per pixel.
    ...
    */
    ...
    /*!
        ...
        Provides the number of bytes transferred for each image or chunk on the stream channel. This includes any end-of-line statistics, end-of-frame statistics, or other stamp data. This is the total size of the data payload for a data block.
    ...
    */
    ...
    static_cast<GENAPI_NAMESPACE::CEnumerationTRef<SensorShutterModeEnums> *> (&SensorShutterMode )->SetNumEnums(1);
    static_cast<GENAPI_NAMESPACE::CEnumerationTRef<SensorShutterModeEnums> *> (&SensorShutterMode )->SetEnumReference( SensorShutterMode_Global, "Global" );        static_cast<GENAPI_NAMESPACE::CEnumerationTRef<OverlapModeEnums> *> (&OverlapMode )->SetReference(_Ptr->GetNode("OverlapMode"));
    ...
    static_cast<GENAPI_NAMESPACE::CEnumerationTRef<ExposureModeEnums> *> (&ExposureMode )->SetEnumReference( ExposureMode_Timed, "Timed" );        static_cast<GENAPI_NAMESPACE::CIntegerRef*> (&AcquisitionFramePeriodRaw )->SetReference(_Ptr->GetNode("AcquisitionFramePeriodRaw"));
    ...
    static_cast<GENAPI_NAMESPACE::CEnumerationTRef<LineSourceEnums> *> (&LineSource )->SetNumEnums(5);
    ...
    static_cast<GENAPI_NAMESPACE::CEnumerationTRef<BconClockFrequencyEnums> *> (&BconClockFrequency )->SetNumEnums(9);
