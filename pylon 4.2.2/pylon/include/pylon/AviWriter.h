...
namespace Pylon
{
    /// Exception fired if a fatal error occurs (e.g. access violations, ...) when creating an AVI video file
    class AviWriterFatalException : public GenICam::GenericException
    {
    public:
