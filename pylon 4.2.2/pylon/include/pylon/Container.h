    ...
    */
    ...
    public:
        ...
        public:
            ...
            bool                    operator <=       ( const const_iterator &iter ) const;
            bool                    operator >=       ( const const_iterator &iter ) const;
            template <class T> PYLONBASE_API friend typename TList<T>::const_iterator operator +(intptr_t iInc, const typename TList<T>::const_iterator &iter);
        ...
        public:
            ...
            template <class T> PYLONBASE_API friend typename TList<T>::iterator operator +( intptr_t iInc, const typename TList<T>::iterator &iter);
        };
