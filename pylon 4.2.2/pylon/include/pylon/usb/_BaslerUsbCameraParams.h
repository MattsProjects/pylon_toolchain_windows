...
namespace Basler_UsbCameraParams
{
    ...
    //@{
	/*!	
		\brief Enables or disables the sequencer for image acquisition.
    ...
    */
    ...
    //@{
	/*!	
		\brief Indicates the index number of the currently active sequencer set.
    ...
    */
    ...
    //@{
	/*!	
		\brief Sequencer set that will be used with the first frame start trigger after SequencerMode was set to On.
    ...
    */
    ...
    //@{
	/*!	
		\brief Selects the sequencer set index number.
    ...
    */
    ...
    //@{
	/*!	
		\brief Loads the parameter values of a sequencer set into the the active set.
    ...
    */
    ...
    //@{
	/*!	
		\brief Saves the sequencer parameter values that are currently in the active set.
    ...
    */
    ...
    //@{
	/*!	
		\brief Selects the sequencer path.
    ...
    */
    ...
    //@{
	/*!	
		\brief Specifies the next sequencer set to follow after the current one.
    ...
    */
    ...
    //@{
	/*!	
		\brief Selects the trigger source for sequencer set advance.
    ...
    */
    ...
    //@{
	/*!	
		\brief Selects the level for the trigger source.
    ...
    */
    ...
    //@{
	/*!	
		\brief Align output image data to multiples of 4 bytes.
    ...
    */
    ...
    //@{
	/*!	
		\brief The number of bytes separating the starting pixels of two consecutive lines.
...
#   pragma warning(pop)
    ...
    */
    ...
    //@{
	/*!	
		\brief Selects the software signal to control.
    ...
    */
    ...
    //@{
	/*!	
		\brief Generates a signal that can be used as a software trigger.
